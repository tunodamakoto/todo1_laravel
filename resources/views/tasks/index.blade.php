                ...
                <form action="/tasks" method="post" class="mt-10">
                    ...
                    <div class="flex flex-col items-center">
                        <label class="w-full max-w-3xl mx-auto">
                            <input type="text" placeholder="洗濯物をする..." name="task_name" class="placeholder:italic placeholder:text-slate-400 block bg-white w-full border border-slate-300 rounded-md py-4 pl-4 shadow-sm focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1 sm:text-sm">
                            @error('task_name')
                                <div class="mt-3">
                            ...
                            <div class="overflow-hidden shadow ring-1 ring-black ring-opacity-5 md:rounded-lg">
                                <table class="min-w-full divide-y divide-gray-300">
                                    <thead class="bg-gray-50">
                                        <tr>
                                            <th scope="col" class="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900">タスク</th>
